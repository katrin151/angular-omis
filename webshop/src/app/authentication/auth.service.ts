...
export class AuthService {
  ...
  signUp(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBvhRQgRf-3a61F5OUzciWpy_JODqSGvOw',
    {
      email: email,
      password: password,
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBvhRQgRf-3a61F5OUzciWpy_JODqSGvOw',
        {
          email: email,
          password: password,
          returnSecureToken: true
